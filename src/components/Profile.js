...
class Profile extends React.Component{
  ...
  showSwitch = () => {
    if(this.props.data) {
      return (
        <a href={'/profile/changeStatus/' + this.props.data._id}>
          <p className={this.props.data.showVacs == 'no' ? 'switch switchLock' : 'switch'}>
          <span className={this.props.data.showVacs == 'no' ? 'slider beforeLock' : 'slider'}></span>
        </p></a>
      )
    }
  }
  ...
  render() {
            ...
            return(
              <div className='wrap_profile' ref={this.profile}>
              ...
              <div className='wrap_burger' ref={this.burger}>
                  ...
                  <div className='title_of'>
                      <p id='titleIn'>{this.props.data ? this.props.data.name : null}</p>
                   ...
                   <div className='card1'>
                         ...
                         <div className='prt2 comPrt'>
                                  ...
                                  <form method="POST" action="/profile/uploadsProfileImages" className="forma" encType="multipart/form-data">
                                      <p id='impComp'>{this.props.data && this.props.data.profileImage != null ? "Change company logo " : "Choose company logo "}
                         ...
                         <div className='prt3 comPrt'>
                                 ...
                                 <p className='common_Cred'>{this.props.data ? this.props.data.request : null}</p>
                         </div>
                         <div className='prt4 comPrt'>
                                <p className='titOdCred'>Industry</p>
                                <p className='common_Cred'>{this.props.data ? this.props.data.industry : null}</p>
                         </div>
                         <div className='prt5 comPrt'>
                               <p className='titOdCred'>Jurisdiction</p>
                               <p className='common_Cred'>{this.props.data ? this.props.data.jurisdiction : null}</p>
                         </div>
                         <div className='prt6 comPrt'>
                                <p className='titOdCred'>Company  description</p>
                                <p className='common_Cred'>{this.props.data ? this.props.data.description : null}</p>
                         </div>
                         <div className='prt7 comPrt'>
                               <p className='titOdCred'>Problem solved</p>
                               <p className='common_Cred'>{this.props.data ? this.props.data.solved : null}</p>
                        </div>
                        <div className='prt8 comPrt'>
                              <p className='titOdCred'>Contacts</p>
                              <p className='common_Cred'>{this.props.data ? this.props.data.phone : null}
                              <p className='common_Cred'>{this.props.data ? this.props.data.email : null}</p>
                              </p>
                       </div>
                  </div>
